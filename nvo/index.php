            ...
            <div class="contacts-area mg-b-15">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        $sql5 = "SELECT * FROM usuarios WHERE ID=' $_SESSION[alogin]'";
                        $result5 = mysqli_query($con,$sql5);
                       	$mostrar5=(mysqli_fetch_array($result5));
                       	$nombre = $mostrar5['Nombre'];

                        echo "<h1 class='style8' align=center>Bienvenido al área administrativa </br> $nombre</h1>";
                        ?>
                        </br></br>
                       <center> <img  src="img/adminindex.jpg"></center>
                    </div>
                </div>
            </div>
