...
<body>
    ...
    <div class="all-content-wrapper">
	    ...
	    echo "<h1 class='style8' align=center>Bienvenido al examen $nombre</h1>";
	    echo "</br></br>";
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright © 2020. Todos los derechos reservados. <a href="https://colorlib.com/wp/templates/"></a></p>
                        </div>
                    </div>
                </div>
            </div>
