                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <input name="name" type="text" class="form-control" placeholder="Nombre de la prueba" id ="name">
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="lugar" type="text" class="form-control" placeholder="Lugar" id = "lugar">
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="fecha" type="date" class="form-control" placeholder="Fecha" id "fecha">
                                                            </div>
															<div class="form-group">
                                                                <input name="nre" type="text" class="form-control" placeholder="Cantidad de reactivos" id "nre">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <input name="h_inicio" type="time" class="form-control" placeholder="Hora de inicio" id = "h_inicio">
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="h_fin" type="time" class="form-control" placeholder="Hora de fin" id = "h_fin">
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="passex" type="text" class="form-control" placeholder="Contraseña" id = "passex">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
