...
<body>
    ...
    $sql = "SELECT * From reactivos";
    $result = mysqli_query($con,$sql);

    /*How may adjacent page links should be shown on each side of the current page link.*/
    $limit = 20;
    $adjacents = 2;
    $sql2 = "SELECT COUNT(*) 'total_rows' FROM reactivos";
    ...
    if(isset($_GET['page']) && $_GET['page'] != "") {
      ...
      $query  = "SELECT * From reactivos limit $offset, $limit";
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            ...
                            <div class="add-product">
                                <a href="agregar_reactivo.php?idex=<?php echo $idex ?>">Agregar reactivos</a>
                            </div>
                            <div class="product-status-wrap drp-lst">
                            </div>
                                ...
                                <table>
                                    ...
                                    <?php
                                            if($_POST){
                                                ...
                                                $sql4 = "SELECT * FROM reactivos WHERE Pregunta LIKE '%$buscar%' ";
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        ...
                                        <li class='page-item <?php ($page <= 1 ? print 'disabled' : '')?>'>
                                          <a class='page-link' href='lista_reactivos.php?page=<?php ($page>1 ? print($page-1) : print 1)?>'>Anterior</a>
                                        </li>
                                        <!-- Links of the pages with page number -->
                                        <?php for($i=$start; $i<=$end; $i++) { ?>
                                        <li class='page-item <?php ($i == $page ? print 'active' : '')?>'>
                                          <a class='page-link' href='lista_reactivos.php?page=<?php echo $i;?>'><?php echo $i;?></a>
                                        </li>
                                        <?php } ?>
                                        <!-- Link of the next page -->
                                        <li class='page-item <?php ($page >= $total_pages ? print 'disabled' : '')?>'>
                                          <a class='page-link' href='lista_reactivos.php?page=<?php ($page < $total_pages ? print($page+1) : print $total_pages)?>'>Siguiente</a>
                                        </li>
                                    </ul>
                                    <?php } ?>
