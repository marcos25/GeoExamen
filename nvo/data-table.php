...
<body>
    ...
    $limit = 20;
    $adjacents = 2;
    $sql2 = "SELECT COUNT(*) 'total_rows' FROM usuarios WHERE Clase='0' and Estado = '0'";
   ...
   if(confirm("¿Esta seguro que desea eliminar el examen?")){
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Solicitudes</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="asset-inner">
                                <table data-search="true">
                                    <tr>
                                        ...
                                        <th data-field="states">Status</th>
                                    ...
                                    <?php
                                        ...
                                        <td><?php echo $mostrar4['Correo']?></td>
    ...
    <script src="js/main.js"></script>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href= "../admin/aceptar_soli.php?id=<?php echo $mostrar['ID']?>"> <i class="fa fa-check" aria-hidden="true"></i></a></td>
                                        <td><a onclick= "confirmar_eliminar(location='../admin/deleteuser.php?id=<?php echo $mostrar['ID'];?>')"> <i class="fa fa-times" aria-hidden="true"></i></a></td>
                                    </tr>
                                <?php
                                     }
                                     ?>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        ...
                                        <li class='page-item <?php ($page >= $total_pages ? print 'disabled' : '')?>'>
                                          <a class='page-link' href='data-table.php?page=<?php ($page < $total_pages ? print($page+1) : print $total_pages)?>'>Siguiente</a>
                                        </li>
                                    </ul>
                                    <?php } ?>
