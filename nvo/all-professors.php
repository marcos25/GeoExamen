...
<body>
    ...
    $limit = 20;
    $adjacents = 2;
    $sql2 = "SELECT COUNT(*) 'total_rows' FROM usuarios WHERE Clase='1' and Estado = '1'";
    ...
    if(isset($_GET['page']) && $_GET['page'] != "") {
      ...
      $query  = "SELECT * From usuarios WHERE Clase='1' and Estado = '1' limit $offset, $limit";
                                            ...
                                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                                                <div class="student-inner-std res-mg-b-30">
                                                    <div class="student-dtl">
                                                        <h2><?php echo $mostrar4['Nombre']?></h2>
