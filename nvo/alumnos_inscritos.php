...
<body>
    ...
    $limit = 20;
    $adjacents = 2;
    $sql2 = "SELECT COUNT(*) 'total_rows' FROM usuarios WHERE Clase='0' and IDExamen = '$id' and Estado = '1'";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Aspirantes</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            <h4>Lista de aspirantes inscritos</h4>
                            <div class="add-product">
                                <a href="inscribir_examen.php?idex=<?php echo $id ?>">Inscribir alumno</a>
                            </div>
                            <div class="product-status-wrap drp-lst">
                            </div>
