...
<body>
    <?php
      ...
      /*How may adjacent page links should be shown on each side of the current page link.*/
        $sql2 = "SELECT COUNT(*) 'total_rows' FROM examen WHERE  Estado = '1'";
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            ...
                            <div class="add-product">
                                <a href="add-department.php">Agregar examen</a>
                            </div>
                            <div class="product-status-wrap drp-lst">
                            </div>
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination">
                                        ...
                                        <li class='page-item <?php ($page <= 1 ? print 'disabled' : '')?>'>
                                          <a class='page-link' href='departments.php?page=<?php ($page>1 ? print($page-1) : print 1)?>'>Anterior</a>
                                        </li>
                                        <!-- Links of the pages with page number -->
                                        <?php for($i=$start; $i<=$end; $i++) { ?>
                                        <li class='page-item <?php ($i == $page ? print 'active' : '')?>'>
                                          <a class='page-link' href='departments.php?page=<?php echo $i;?>'><?php echo $i;?></a>
                                        </li>
                                        <?php } ?>
                                        <!-- Link of the next page -->
                                        <li class='page-item <?php ($page >= $total_pages ? print 'disabled' : '')?>'>
                                          <a class='page-link' href='departments.php?page=<?php ($page < $total_pages ? print($page+1) : print $total_pages)?>'>Siguiente</a>
                                        </li>
                                        </ul>
                                        <?php } ?>
